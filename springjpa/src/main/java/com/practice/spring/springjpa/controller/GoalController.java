package com.practice.spring.springjpa.controller;
...
import com.practice.spring.springjpa.repository.service.GoalService;
...
public class GoalController {
	...
	public String getGoalReports(Model model) {
		...
		List<GoalReports> goalReports= goalService.findAllGoalReports();
